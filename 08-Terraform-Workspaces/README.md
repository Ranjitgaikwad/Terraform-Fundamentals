...
```t
  ...
  backend "s3" {
    bucket = "terraform-Ranjit-Gaikwad"
...
Go to AWS Mgmt Console -> Services -> S3 -> terraform-Ranjit-Gaikwad -> workspaces -> terraform.tfstate
```
...
Go to AWS Mgmt Console -> Services -> S3 -> terraform-Ranjit-Gaikwad -> env:/ -> dev -> workspaces -> terraform.tfstate
```
